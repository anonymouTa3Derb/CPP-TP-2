...
// Une Collection est une collection ordonnée de Trajets
// La Collection contrôle l'allocation et la libération de mémoire
...
// La Collection permet d'ajouter un Trajet, et d'accéder à un Trajet :
...
//-------------------------------------------- Constructeurs - destructeur
    ...
    // Recopie en profondeur de uneCollection
    // Contrat :
    // Rien

    Collection ( bool triAlpha = false );
    // Mode d'emploi :
    // Construction d'une Collection ordonnée, vide
